...
import { LaptopOutlined, SaveOutlined, ClearOutlined } from '@ant-design/icons';
...
const LaptopEntry = () => {
  ...
  const onFinish = (values) => {
    ...
    alert('Laptop entry saved successfully!');
    form.resetFields();
  };
  ...
  return (
    <Card className="inventory-card">
      <Title level={3}><LaptopOutlined /> Laptop Entry Form</Title>
      
      <Form
        form={form}
        name="laptopEntryForm"
        layout="vertical"
        onFinish={onFinish}
        autoComplete="off"
      >
        ...
        <Row gutter={16}>
          ...
          <Col span={8}>
            <Form.Item
              name="laptop"
              label="Laptop"
              rules={[{ required: true, message: 'Please enter laptop details' }]}
            >
              <Input placeholder="Enter laptop details" />
            </Form.Item>
          </Col>
